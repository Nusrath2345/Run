...
public class MainFrame extends JFrame implements NavigationListener {
    ...
    public MainFrame() {
        super("Rún - Cybersecurity Fundamentals");
        ...
        cardPanel.add(new ScanHistoryPanel(this), SCAN_HISTORY);
        cardPanel.add(new HelpPanel(),                HELP);
    ...
    private JPanel buildSidebar() {
        ...
        addNavButton(sidebar, "Scan History",     SCAN_HISTORY);
        addNavButton(sidebar, "Help",             HELP);
    ...
    // call after login to update the navbar with the real user email
